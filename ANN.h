...
// Thu May 10 07:23:00 2018 by ROOT version 6.12/04
// from TTree fTree/DiPhotonTree
// found on file: GGJets_M-500To1000_Pt-50_13TeV-sherpa_RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v2_numEvent100.root
//////////////////////////////////////////////////////////
...
#ifdef ANN_cxx
ANN::ANN(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("GGJets_M-500To1000_Pt-50_13TeV-sherpa_RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v2_numEvent100.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("GGJets_M-500To1000_Pt-50_13TeV-sherpa_RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v2_numEvent100.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("GGJets_M-500To1000_Pt-50_13TeV-sherpa_RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v2_numEvent100.root:/diphoton");
...
Int_t ANN::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ANN::LoadTree(Long64_t entry)
{
